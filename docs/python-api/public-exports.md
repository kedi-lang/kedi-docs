...
| `SubagentScope`, `SubagentTask`, `SubagentResult` | Invocation-owned child scope, awaitable task handle, and completed result with typed `output`. [Python Embedding](../agentic-engineering/subagent-python.md), [Native Tasks](../agentic-engineering/subagent-tasks.md) |
